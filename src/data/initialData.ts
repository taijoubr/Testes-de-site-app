...
export const INITIAL_FINANCIALS: FinancialTransaction[] = [
  {
    id: 'FIN-2026-001',
    title: 'Mensalidade Sustentação App Mobile - Grupo Saúde360',
    type: 'receita',
    category: 'Mensalidades / Recorrência',
    subcategory: 'Sustentação & Hospedagem',
    ...
    clientEmail: 'financeiro@saude360.com.br',
    clientPhone: '(11) 98888-1122',
    contractNumber: 'CTR-2026-001',
    isRecurring: true,
    entityType: 'cliente',
    invoiceNumber: 'NF-8921',
    createdUser: 'Nikolas P.',
    reconciled: true,
    reconciledAt: '2026-08-05T14:20:00Z',
    reconciledBy: 'Juliana Costa',
    notes: 'Pago via PIX com desconto de pontualidade',
    auditLogs: [
      {
        id: 'log-01',
        ...
        user: 'Sistema',
        action: 'Cadastro',
        details: 'Cobrança recorrente gerada automaticamente',
        targetType: 'transaction',
        targetId: 'FIN-2026-001'
      },
      {
        id: 'log-02',
        timestamp: '2026-08-05T14:20:00Z',
        user: 'Juliana Costa',
        action: 'Pagamento Baixado',
        details: 'Baixa manual confirmada via comprovante PIX Itaú',
        targetType: 'transaction',
        targetId: 'FIN-2026-001'
      }
    ]
  ...
  {
    id: 'FIN-2026-002',
    title: 'Hospedagem AWS & Cloudflare Enterprise (Santos Logistics)',
    type: 'receita',
    category: 'Mensalidades / Recorrência',
    subcategory: 'Infraestrutura Cloud',
    costCenter: 'Infraestrutura Cloud',
    amount: 1800,
    dueDate: '2026-08-15',
    status: 'pendente',
    paymentMethod: 'pix',
    clientName: 'Santos Logistics & Tech',
    clientCpfCnpj: '98.765.432/0001-10',
    clientEmail: 'carlos@santoslogistics.com.br',
  ...
  {
    id: 'FIN-2026-003',
    title: 'Manutenção & Manutenção Preventiva - SalesFlow Corp',
    type: 'receita',
    category: 'Mensalidades / Recorrência',
    ...
    clientName: 'SalesFlow Corp',
    clientCpfCnpj: '45.123.890/0001-33',
    clientEmail: 'financeiro@salesflow.com',
  ...
  {
    id: 'FIN-2026-004',
    title: 'Entrada 50% - Projeto SaaS Gestão de Frota',
    type: 'receita',
    category: 'Projetos / Desenvolvimento',
    ...
    reconciled: true,
    reconciledAt: '2026-08-02T16:00:00Z',
    reconciledBy: 'Juliana Costa'
  },
  {
    id: 'FIN-2026-005',
    title: 'Infraestrutura AWS Cloud & Clusters Kubernetes - Julho',
    type: 'despesa',
    category: 'Servidores & Cloud',
    subcategory: 'AWS Infra',
    costCenter: 'Infraestrutura Cloud',
    amount: 3240,
    dueDate: '2026-08-05',
  ...
  {
    id: 'FIN-2026-006',
    title: 'Assinatura Licenças OpenAI / Google Cloud AI API',
    type: 'despesa',
    ...
    status: 'pendente',
    paymentMethod: 'cartao',
    supplierName: 'Google Cloud Platform',
    entityType: 'empresa'
  },
  {
    id: 'FIN-2026-007',
    title: 'Comissão de Vendas - Contrato Santos Logistics (Gabriel S.)',
    type: 'despesa',
    category: 'Comissões',
    subcategory: 'Equipe Comercial',
    costCenter: 'Vendas',
    amount: 1425,
    dueDate: '2026-08-15',
    status: 'pendente',
    paymentMethod: 'pix',
    supplierName: 'Gabriel Souza (Dev / Comercial)',
    entityType: 'empresa'
  },
  {
    id: 'FIN-2026-008',
    title: 'Mensalidade Suporte VIP - ImobiGroup',
    type: 'receita',
    category: 'Mensalidades / Recorrência',
    subcategory: 'Suporte VIP',
    costCenter: 'Operacional',
    amount: 2200,
    dueDate: '2026-08-01',
    status: 'atrasado',
    paymentMethod: 'pix',
    clientName: 'ImobiGroup',
    clientEmail: 'contato@imobigroup.com.br',
    clientPhone: '(11) 97777-6655',
    isRecurring: true,
    entityType: 'cliente',
    notes: 'Aviso de cobrança enviado via WhatsApp no dia 04/08'
  },
  {
    id: 'FIN-2026-009',
    title: 'Manutenção Preventiva Servidores - TechStore Brasil',
    type: 'receita',
    category: 'Mensalidades / Recorrência',
  ...
  {
    id: 'FIN-2026-010',
    title: 'Aluguel do Escritório & Condomínio',
    type: 'despesa',
    category: 'Custos Fixos / Escritório',
    subcategory: 'Infraestrutura Física',
    costCenter: 'Pessoal',
    amount: 4500,
    dueDate: '2026-08-10',
    status: 'pendente',
    paymentMethod: 'transferencia',
    supplierName: 'Administradora Birmann',
    entityType: 'empresa'
  }
];
...
export const INITIAL_SUBSCRIPTIONS: ClientSubscription[] = [
  {
    ...
    clientPhone: '(11) 98888-1122',
    clientCpfCnpj: '12.345.678/0001-90',
    serviceName: 'Sustentação de App Mobile & Hospedagem AWS',
    monthlyValue: 2800,
    billingCycleDay: 10,
    status: 'ativo',
    ...
    paymentMethod: 'pix',
    notes: 'Contrato de 12 meses renovável automaticamente com reajuste pelo IGPM.',
    pixCopyPaste: '00020126580014br.gov.bcb.pix0136d817452e-503a-4f51-b06f-123456789abc52040000530398654072800.005802BR5918NCodes Technologies6009SAO PAULO62070503***6304E8A2',
    ...
    adjustmentsHistory: [
      {
        ...
        oldValue: 2500,
        newValue: 2800,
        reason: 'Reajuste contratual anual pelo IPCA + ampliação de espaço em storage S3.'
      }
    ]
  },
  {
    ...
    clientPhone: '(11) 98765-4321',
    clientCpfCnpj: '98.765.432/0001-10',
    serviceName: 'Hospedagem & Infraestrutura Cloud Dedicada',
    monthlyValue: 1800,
    billingCycleDay: 15,
    status: 'ativo',
  ...
  },
  {
    ...
    clientName: 'SalesFlow Corp',
    clientEmail: 'financeiro@salesflow.com',
    clientPhone: '(11) 93333-2211',
    clientCpfCnpj: '45.123.890/0001-33',
    serviceName: 'Manutenção de CRM & Suporte Nível 2',
    monthlyValue: 3500,
    billingCycleDay: 20,
    status: 'ativo',
  ...
  },
  {
    ...
    clientEmail: 'contato@imobigroup.com.br',
    clientPhone: '(11) 97777-6655',
    serviceName: 'BotAtende IA - Licença de Uso & API WhatsApp',
    monthlyValue: 2200,
    billingCycleDay: 1,
    status: 'inadimplente',
    ...
    entityType: 'cliente',
    notes: 'Atrasado em 5 dias. Régua de cobrança automática em andamento.',
    autoSuspendDays: 15
  },
  {
    id: 'SUB-2026-005',
    clientName: 'TechStore Brasil',
    clientEmail: 'atendimento@techstore.com.br',
    serviceName: 'Sustentação E-commerce & Checkout Transparente',
    monthlyValue: 1900,
    billingCycleDay: 25,
    status: 'ativo',
